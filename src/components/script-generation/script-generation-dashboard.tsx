  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <Button size="sm" variant="outline" onClick={handleCopyCaption} className="border-border gap-1.5 text-xs">
              ...
              <Button size="sm" variant="outline" onClick={handleCopyHashtags} className="border-border gap-1.5 text-xs">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-muted hover:bg-muted text-white font-bold gap-1.5 text-xs"
              >
      ...
      {teleprompterOpen && (
        <Card className="border-border bg-black text-white p-8 shadow-none border-2">
          ...
          <div className="space-y-6 font-mono text-lg md:text-xl leading-relaxed max-w-4xl mx-auto">
            <div className="p-6 rounded-md bg-muted border border-border">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-2 border-border bg-card shadow-none flex flex-col justify-between">
          <CardHeader className="pb-3">
            <Badge className="w-fit bg-muted text-white mb-1">Reel Concept & Hook Mechanics</Badge>
      ...
      <Card className="border-border bg-card shadow-none">
        ...
        <CardContent>
          <Accordion type="single" collapsible defaultValue="scene-1" className="space-y-3">
            {pkg.scenes.map((scene) => (
              <AccordionItem key={scene.sceneNumber} value={`scene-${scene.sceneNumber}`} className="border border-border/80 rounded-md px-4 bg-background">
                <AccordionTrigger className="hover:no-underline py-4">
                  <div className="flex items-center gap-3 text-left">
                    <span className="flex items-center justify-center h-8 w-8 rounded-lg bg-muted text-white font-bold text-xs shrink-0">
                      #{scene.sceneNumber}
                    </span>
                    <div>
                ...
                <AccordionContent className="pb-4 pt-2 space-y-4 border-t border-border/40">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-muted-foreground p-3 rounded-lg bg-muted border border-border">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="border-border bg-card shadow-none flex flex-col justify-between">
          ...
          <CardContent>
            <pre className="p-4 rounded-md bg-background border border-border/80 text-xs text-foreground font-sans whitespace-pre-wrap leading-relaxed max-h-[320px] overflow-y-auto">
              {pkg.caption.fullCaption}
            </pre>
          </CardContent>
        </Card>
            ...
            {[
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-2.5 p-3 rounded-md border cursor-pointer transition-all ${
                    isChecked
