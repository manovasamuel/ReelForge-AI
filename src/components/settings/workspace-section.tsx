  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="border-t border-border pt-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">Select which workspace hub opens automatically when launching ReelForge AI.</p>
      ...
      <div className="border-t border-border pt-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">Maximum number of recent analyses shown on the quick-switch bar.</p>
