...
export function WorkspaceDashboard({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 p-4 rounded-md border border-border bg-card">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 bg-background border-border text-foreground placeholder:text-muted-foreground h-10 text-sm rounded-md"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="h-10 px-3 py-1 rounded-md bg-background border border-border text-sm font-medium text-foreground focus:outline-none cursor-pointer"
          >
      ...
      {projectToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 animate-in fade-in duration-200 p-4">
          <div className="w-full max-w-md rounded-md border border-border bg-card p-6 shadow-none space-y-5">
            ...
            <div className="p-3 rounded-md bg-muted border border-border text-xs space-y-1">
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <Button
                ...
                className="text-xs font-medium gap-1.5 px-4 shadow-none"
              >
                Delete Permanently
              </Button>
            </div>
