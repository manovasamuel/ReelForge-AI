...
- Name: studio-validation.spec.ts >> Profile URL Validation >> should clear error when user types after an invalid submission
- Location: tests\e2e\studio-validation.spec.ts:40:7
...
- main:
  ...
  - textbox "https://instagram.com/username": bad-url
