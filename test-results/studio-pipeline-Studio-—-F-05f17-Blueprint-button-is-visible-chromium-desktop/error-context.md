...
- Name: studio-pipeline.spec.ts >> Studio — Full Pipeline (Phases 1–9) >> Phase 7: Generate Content DNA Blueprint button is visible
- Location: tests\e2e\studio-pipeline.spec.ts:78:7
