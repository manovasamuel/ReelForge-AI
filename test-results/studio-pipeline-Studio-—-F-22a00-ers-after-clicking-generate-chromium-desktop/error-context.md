...
- Name: studio-pipeline.spec.ts >> Studio — Full Pipeline (Phases 1–9) >> Phase 7: Content DNA Blueprint renders after clicking generate
- Location: tests\e2e\studio-pipeline.spec.ts:91:7
