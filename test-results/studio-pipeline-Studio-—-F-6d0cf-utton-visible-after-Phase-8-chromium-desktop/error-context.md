...
- Name: studio-pipeline.spec.ts >> Studio — Full Pipeline (Phases 1–9) >> Phase 9: Generate Repurpose Package button visible after Phase 8
- Location: tests\e2e\studio-pipeline.spec.ts:135:7
