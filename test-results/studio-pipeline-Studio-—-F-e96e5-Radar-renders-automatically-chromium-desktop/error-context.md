...
- Name: studio-pipeline.spec.ts >> Studio — Full Pipeline (Phases 1–9) >> Phase 3: Competitor Radar renders automatically
- Location: tests\e2e\studio-pipeline.spec.ts:34:7
