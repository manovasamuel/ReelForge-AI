...
- Name: studio-pipeline.spec.ts >> Studio — Full Pipeline (Phases 1–9) >> Phase 4: Competitor Analysis triggers on clicking Analyze button
- Location: tests\e2e\studio-pipeline.spec.ts:45:7
