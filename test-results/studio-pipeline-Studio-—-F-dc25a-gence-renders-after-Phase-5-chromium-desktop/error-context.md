...
- Name: studio-pipeline.spec.ts >> Studio — Full Pipeline (Phases 1–9) >> Phase 6: Content Intelligence renders after Phase 5
- Location: tests\e2e\studio-pipeline.spec.ts:67:7
