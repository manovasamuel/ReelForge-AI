...
ALTER TABLE "brand_assets" ADD COLUMN "workspace_id" uuid;--> statement-breakpoint
ALTER TABLE "brand_profiles" ADD COLUMN "workspace_id" uuid;--> statement-breakpoint
ALTER TABLE "long_term_memories" ADD COLUMN "workspace_id" uuid;--> statement-breakpoint
...
ALTER TABLE "long_term_memories" ADD CONSTRAINT "long_term_memories_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
